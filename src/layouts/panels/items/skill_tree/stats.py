...
class _TreeStatsPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        title.setStyleSheet(f"color: {Colors.ACCENT}; font-size: 8px; font-weight: bold; background: transparent; border: none;")
        lay.addWidget(title)
        ...
        self._stats_lbl.setStyleSheet(f"color: {Colors.TEXT_SECONDARY}; font-size: 8px; background: transparent; border: none;")
