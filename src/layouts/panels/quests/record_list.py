...
Cópia de dungeons/record_list.py com uma única diferença: `status_dot` vem
de quests.constants (Ativa/Em progresso/Rascunho/Desativada), não de
dungeons.constants (Concluída/Disponível/Bloqueada/Em Andamento) — os dois
módulos têm vocabulários de status diferentes, então não dá pra reaproveitar
o arquivo original sem colorir a bolinha errado.
"""
...
class RecordListColumn(QFrame):
    ...
    pelo botão "+ Nova Quest" no cabeçalho da coluna (ver panel.py), não por
    um card dentro da lista."""
